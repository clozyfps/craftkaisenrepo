...
public class Modelcursespirit1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cursespirit1"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 33)
						.addBox(-12.0F, 10.0F, -1.0F, 24.0F, 14.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(0, 71)
						.addBox(-12.0F, 8.0F, -1.0F, 24.0F, 2.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-13.0F, 17.0F, -2.0F, 26.0F, 7.0F, 26.0F, new CubeDeformation(0.0F)).texOffs(76, 51)
						.addBox(-10.0F, 2.0F, 1.0F, 20.0F, 8.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(78, 0)
						.addBox(-10.0F, 0.0F, 1.0F, 20.0F, 2.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(72, 33)
						.addBox(-8.0F, 0.0F, 3.0F, 16.0F, 2.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(82, 81)
		...
		PartDefinition cube_r1 = bone2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(22, 137).addBox(-12.3614F, -2.1182F, -0.5867F, 8.0F, 3.0F, 4.0F,
		...
		PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(22, 137).addBox(3.8048F, -4.4861F, -0.0941F, 8.0F, 3.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = bone2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, 3.0F, -1.0F, 6.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(72, 33)
						.addBox(-2.0F, -6.0F, -1.0F, 4.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = bone2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(112, 108)
						.addBox(-7.0F, -6.75F, -0.575F, 14.0F, 13.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(84, 108)
						.addBox(-6.0F, -5.75F, -0.5F, 12.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.25F, 1.5F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r5 = bone2.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(3, 140).mirror()
						.addBox(-1.5F, -1.5F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.5F, -5.5F, 2.0F, 0.0154F, -0.1739F, -0.0886F));

		PartDefinition cube_r6 = bone2.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(3, 140).addBox(-1.5F, -1.5F, -2.0F, 3.0F, 3.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.5F, -5.5F, 2.0F, 0.0154F, 0.1739F, 0.0886F));

		PartDefinition cube_r7 = bone2.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(16, 9).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -1.0F, 0.0F, 0.1719F, 0.0302F, -0.1719F));

		PartDefinition cube_r8 = bone2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(16, 17).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -1.0F, 0.0F, 0.1719F, -0.0302F, 0.1719F));

		PartDefinition cube_r9 = bone2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 45).addBox(3.1813F, -6.3437F, -2.0F, 5.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = bone2.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(5.5315F, -4.747F, -3.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 113)
						.addBox(-2.4685F, -4.747F, -3.0F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = bone2.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 97).addBox(-15.1221F, -6.3261F, -4.0F, 15.0F, 8.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = bone2.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 71).addBox(-3.5F, -2.0F, -2.0F, 5.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = bone2.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 33).addBox(2.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = bone2.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(22, 121).addBox(-3.0F, -1.0F, -3.0F, 8.0F, 6.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = bone2.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(38, 105).addBox(-4.0F, 5.0F, -3.0F, 15.0F, 8.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-20.0F, 1.0F, 10.0F, 0.0F, 0.0F, -0.6981F));

		PartDefinition cube_r16 = bone2.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(21, 21).addBox(-6.5213F, -1.0448F, -3.25F, 21.0F, 6.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = bone2.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(18, 18).addBox(-13.8661F, -1.4724F, -2.25F, 12.0F, 6.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.297F, 18.7926F, -1.75F, 0.1739F, 0.0151F, -0.0859F));

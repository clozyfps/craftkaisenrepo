	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head2 = partdefinition.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(12, 16)
						.addBox(-4.0F, -5.0F, -4.01F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.1F)).texOffs(9, 16)
						.addBox(-4.0F, -5.0F, 4.01F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.1F)),
				PartPose.offset(0.0F, 3.0F, 0.0F));

		PartDefinition Head_r1 = Head2.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(10, 19)
						.addBox(-4.0F, -29.0F, 4.01F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.1F)).texOffs(10, 21)
						.addBox(-4.0F, -29.0F, -4.01F, 8.0F, 2.0F, 0.0F, new CubeDeformation(0.1F)),
		...
		PartDefinition Head_r2 = Head2.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(16, 16)
						.addBox(-9.3F, -26.4F, -4.02F, 2.2F, 1.0F, 0.0F, new CubeDeformation(0.1F)).texOffs(16, 19)
						.addBox(-13.0F, -25.0F, -4.02F, 2.1F, 1.0F, 0.0F, new CubeDeformation(0.1F)),
		...
		PartDefinition Head_r3 = Head2.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(16, 18)
						.addBox(10.9F, -25.0F, -4.02F, 2.1F, 1.0F, 0.0F, new CubeDeformation(0.1F)).texOffs(16, 17)
						.addBox(7.1F, -26.4F, -4.02F, 2.2F, 1.0F, 0.0F, new CubeDeformation(0.1F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 0.0F, -0.3491F));

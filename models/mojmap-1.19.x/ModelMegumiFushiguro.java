...
public class ModelMegumiFushiguro<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "megumifushiguro"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0)
				...
				.addBox(-4.0F, -8.25F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(26, 45)
				.addBox(3.25F, -8.0F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(4, 22)
				.addBox(3.25F, -7.0F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(56, 55)
				.addBox(3.25F, -7.0F, -2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(68, 0)
				.addBox(3.25F, -4.0F, 0.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 8)
				.addBox(3.25F, -2.0F, 2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 22).mirror()
				.addBox(-4.25F, -7.0F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(26, 45)
				.mirror().addBox(-4.25F, -8.0F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(56, 55).mirror().addBox(-4.25F, -7.0F, -2.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(68, 0).mirror()
				.addBox(-4.25F, -4.0F, 0.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(48, 8)
				.mirror().addBox(-4.25F, -2.0F, 2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(24, 5).addBox(-4.0F, -8.0F, -4.1F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 34)
				.addBox(-4.0F, -8.0F, 3.25F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 8).addBox(-4.0F,
						-0.5F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition head_r4 = head.addOrReplaceChild("head_r4",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.75F, -1.0F, 0.0F, 3.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -3.95F, -4.1F, 0.0F, 0.0F, -0.0436F));

		PartDefinition head_r5 = head.addOrReplaceChild("head_r5",
				CubeListBuilder.create().texOffs(20, 25).addBox(0.0F, -1.0F, 0.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, -3.0F, -2.0F, 0.0F, -0.2182F, 0.0F));

		PartDefinition head_r6 = head.addOrReplaceChild("head_r6",
				CubeListBuilder.create().texOffs(16, 45).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -3.0F, -2.0F, 0.0F, 0.2182F, 0.0F));

		PartDefinition head_r7 = head.addOrReplaceChild("head_r7",
				CubeListBuilder.create().texOffs(26, 25).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r8 = head.addOrReplaceChild("head_r8",
				CubeListBuilder.create().texOffs(24, 59).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r9 = head.addOrReplaceChild("head_r9",
				CubeListBuilder.create().texOffs(10, 64).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r10 = head.addOrReplaceChild("head_r10",
				CubeListBuilder.create().texOffs(22, 45).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r11 = head.addOrReplaceChild("head_r11",
				CubeListBuilder.create().texOffs(0, 57).mirror()
						.addBox(-1.0F, -0.0004F, 0.0436F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition head_r12 = head.addOrReplaceChild("head_r12",
				CubeListBuilder.create().texOffs(0, 57).addBox(-1.0F, -0.0004F, 0.0436F, 2.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.2936F, -8.0004F, -3.0F, 1.5533F, -1.3963F, -1.5708F));

		PartDefinition head_r13 = head.addOrReplaceChild("head_r13",
				CubeListBuilder.create().texOffs(52, 42).addBox(-4.0F, -0.5F, 0.0F, 8.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone = head.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-5.4078F, -7.8432F, -3.0355F, 0.1187F, -0.1032F, -0.6227F));

		PartDefinition head_r14 = bone.addOrReplaceChild("head_r14",
				CubeListBuilder.create().texOffs(47, 86).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r15 = bone.addOrReplaceChild("head_r15",
				CubeListBuilder.create().texOffs(62, 64).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = head.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.1578F, -2.8432F, 4.7145F, -1.7887F, -1.2197F, 2.5149F));

		PartDefinition head_r16 = bone2.addOrReplaceChild("head_r16",
				CubeListBuilder.create().texOffs(18, 52).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4078F, 1.0932F, 0.2855F, 0.3819F, 0.4891F, 0.7073F));

		PartDefinition head_r17 = bone2.addOrReplaceChild("head_r17",
				CubeListBuilder.create().texOffs(24, 0).addBox(-0.25F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3704F, -1.1041F, -0.9614F, 0.0305F, 0.6102F, 0.0532F));

		PartDefinition bone3 = head.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-5.4078F, -6.3432F, -0.0355F, -0.1283F, 0.8131F, -1.0161F));

		PartDefinition head_r18 = bone3.addOrReplaceChild("head_r18",
				CubeListBuilder.create().texOffs(86, 8).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r19 = bone3.addOrReplaceChild("head_r19",
				CubeListBuilder.create().texOffs(6, 64).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));

		PartDefinition bone9 = head.addOrReplaceChild("bone9", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.8422F, -8.0932F, -4.2855F, 1.2221F, -0.9244F, -0.7684F));

		PartDefinition head_r20 = bone9.addOrReplaceChild("head_r20",
				CubeListBuilder.create().texOffs(84, 74).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r21 = bone9.addOrReplaceChild("head_r21",
				CubeListBuilder.create().texOffs(12, 59).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));

		PartDefinition bone5 = head.addOrReplaceChild("bone5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.5922F, -10.0932F, 5.2145F, -0.7347F, 0.9017F, -0.2824F));

		PartDefinition head_r22 = bone5.addOrReplaceChild("head_r22",
				CubeListBuilder.create().texOffs(0, 16).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r23 = bone5.addOrReplaceChild("head_r23",
				CubeListBuilder.create().texOffs(64, 0).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));

		PartDefinition bone14 = head.addOrReplaceChild("bone14", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.8422F, -6.3432F, 5.7145F, -2.527F, 0.6319F, -2.5961F));

		PartDefinition head_r24 = bone14.addOrReplaceChild("head_r24",
				CubeListBuilder.create().texOffs(83, 83).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r25 = bone14.addOrReplaceChild("head_r25",
				CubeListBuilder.create().texOffs(40, 17).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));

		PartDefinition bone15 = head.addOrReplaceChild("bone15", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.1578F, -4.3432F, 4.7145F, -1.7887F, 1.2197F, -2.5149F));

		PartDefinition head_r26 = bone15.addOrReplaceChild("head_r26",
				CubeListBuilder.create().texOffs(75, 83).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r27 = bone15.addOrReplaceChild("head_r27",
				CubeListBuilder.create().texOffs(0, 25).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));

		PartDefinition bone6 = head.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-0.9078F, -9.3432F, -0.7855F, 0.0543F, 0.9067F, -0.0426F));

		PartDefinition head_r28 = bone6.addOrReplaceChild("head_r28",
				CubeListBuilder.create().texOffs(0, 86).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r29 = bone6.addOrReplaceChild("head_r29",
				CubeListBuilder.create().texOffs(0, 64).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));

		PartDefinition bone13 = head.addOrReplaceChild("bone13", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.9078F, -9.0932F, 2.2145F, -0.3288F, -0.869F, 0.5031F));

		PartDefinition head_r30 = bone13.addOrReplaceChild("head_r30",
				CubeListBuilder.create().texOffs(20, 84).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4078F, 1.0932F, 0.2855F, 0.3819F, 0.4891F, 0.7073F));

		PartDefinition head_r31 = bone13.addOrReplaceChild("head_r31",
				CubeListBuilder.create().texOffs(0, 41).addBox(-0.25F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3704F, -1.1041F, -0.9614F, 0.0305F, 0.6102F, 0.0532F));

		PartDefinition bone8 = head.addOrReplaceChild("bone8", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.9078F, -10.3432F, 2.4645F, -0.054F, 1.2264F, -0.1434F));

		PartDefinition head_r32 = bone8.addOrReplaceChild("head_r32",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r33 = bone8.addOrReplaceChild("head_r33",
				CubeListBuilder.create().texOffs(60, 47).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));
		...
		PartDefinition head_r34 = bone12.addOrReplaceChild("head_r34",
				CubeListBuilder.create().texOffs(84, 20).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4078F, 1.0932F, 0.2855F, 0.3819F, 0.4891F, 0.7073F));

		PartDefinition head_r35 = bone12.addOrReplaceChild("head_r35",
				CubeListBuilder.create().texOffs(44, 0).addBox(-0.25F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3704F, -1.1041F, -0.9614F, 0.0305F, 0.6102F, 0.0532F));

		PartDefinition bone10 = head.addOrReplaceChild("bone10", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-4.4078F, -3.8432F, 2.4645F, -0.5595F, 1.1524F, -1.6485F));

		PartDefinition head_r36 = bone10.addOrReplaceChild("head_r36",
				CubeListBuilder.create().texOffs(39, 84).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4078F, 1.0932F, 0.2855F, 0.3819F, -0.4891F, -0.7073F));

		PartDefinition head_r37 = bone10.addOrReplaceChild("head_r37",
				CubeListBuilder.create().texOffs(58, 13).addBox(-0.75F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3704F, -1.1041F, -0.9614F, 0.0305F, -0.6102F, -0.0532F));
		...
		PartDefinition head_r38 = bone11.addOrReplaceChild("head_r38",
				CubeListBuilder.create().texOffs(84, 31).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4078F, 1.0932F, 0.2855F, 0.3819F, 0.4891F, 0.7073F));

		PartDefinition head_r39 = bone11.addOrReplaceChild("head_r39",
				CubeListBuilder.create().texOffs(48, 37).addBox(-0.25F, -1.5F, 0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3704F, -1.1041F, -0.9614F, 0.0305F, 0.6102F, 0.0532F));
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(0, 41)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(24, 61)
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(36, 37)
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 47)

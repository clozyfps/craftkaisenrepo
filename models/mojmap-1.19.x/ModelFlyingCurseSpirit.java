...
public class ModelFlyingCurseSpirit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flyingcursespirit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(72, 19)
						.addBox(-8.0F, -2.0F, -18.0F, 16.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(72, 0)
						.addBox(-10.0F, -3.0F, -15.0F, 20.0F, 6.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 21.0F, -6.5F, 0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -3.0F, -4.0F, 4.0F, 6.0F, 8.0F,
						new CubeDeformation(-0.001F)),
				PartPose.offsetAndRotation(7.0329F, 0.0F, -18.3461F, 0.0F, 0.2618F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 36).addBox(-2.3908F, -0.5145F, -1.5796F, 4.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -3.5F, -9.5F, -0.1068F, 0.3786F, -0.2823F));

		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 43).addBox(-1.6092F, -0.5145F, -1.5796F, 4.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -3.5F, -9.5F, -0.1068F, -0.3786F, 0.2823F));

		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 14).addBox(-2.0F, -3.0F, -4.0F, 4.0F, 6.0F, 8.0F,
						new CubeDeformation(-0.001F)),
				PartPose.offsetAndRotation(-7.0329F, 0.0F, -18.3461F, 0.0F, -0.2618F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-11.0F, -2.2647F, -0.4947F, 22.0F, 8.0F, 28.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 19.7647F, -8.5053F));

		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(28, 92).addBox(-3.5F, -1.0F, -4.0F, 6.0F, 3.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = body.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(100, 26).addBox(-2.5F, -1.0F, -4.0F, 6.0F, 3.0F, 7.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.1651F, -1.0147F, 28.8534F, 0.1309F, 0.5236F, 0.0F));

		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(72, 106).addBox(-4.0F, -3.0F, -6.0F, 8.0F, 6.0F, 12.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = body.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(44, 94).addBox(-4.0F, -3.0F, -6.0F, 8.0F, 6.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.4166F, 1.7353F, 31.9156F, 0.0873F, -0.2618F, 0.0F));

		PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing",
				CubeListBuilder.create().texOffs(0, 64).addBox(0.0F, -1.0F, -10.0F, 22.0F, 4.0F, 24.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = left_wing.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(68, 64).addBox(-11.5F, -0.25F, -8.0F, 22.0F, 2.0F, 18.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_wing = partdefinition.addOrReplaceChild("right_wing",
				CubeListBuilder.create().texOffs(0, 36).addBox(-22.0F, -1.0F, -10.0F, 22.0F, 4.0F, 24.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-10.75F, 19.0F, 1.25F, 0.0F, 0.0F, 0.0436F));

		PartDefinition cube_r13 = right_wing.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(68, 36).addBox(-10.5F, -0.25F, -8.0F, 22.0F, 2.0F, 18.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-33.0331F, -0.4808F, -1.0F, 0.0F, 0.0F, 0.0436F));

...
public class Modeltoji_curse<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "toji_curse"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 35).addBox(-2.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8693F, 8.5057F, -2.0F, -0.0153F, 0.1296F, -0.0886F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -2.5F, -2.875F, 5.0F, 5.0F, 4.75F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.5491F, -1.514F, -2.9386F, 0.5634F, 1.4061F, 0.3377F));

		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 11).addBox(-2.5F, -1.5F, -4.375F, 5.0F, 3.0F, 3.75F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(16, 16).addBox(-2.5F, -1.5F, -1.375F, 5.0F, 3.0F, 2.75F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(21, 0).addBox(-1.0F, -2.5F, -1.875F, 4.0F, 3.0F, 2.75F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Body.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(32, 7).addBox(-2.5F, -2.5F, -1.375F, 4.0F, 3.0F, 1.75F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(24, 23).addBox(-1.5F, -2.0F, -0.875F, 3.0F, 3.0F, 2.75F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = Body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 19).addBox(-2.0F, -1.5F, -1.375F, 3.0F, 3.0F, 3.75F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = Body.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 29).addBox(-3.0F, -1.5F, -1.5F, 4.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = Body.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(30, 13).addBox(-2.0F, -1.5F, -0.5F, 4.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Body.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(22, 30)
						.addBox(-0.5F, -3.5F, 0.5F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(17, 7)
						.addBox(-1.5F, -2.5F, -2.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = Body.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(10, 32).addBox(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = Body.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(32, 33).addBox(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = Body.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(34, 19).addBox(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = Body.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(11, 23)
						.addBox(-3.0F, -2.0F, -1.0F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(35, 28)
						.addBox(-1.0F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),

...
public class Modelshinjukufit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shinjukufit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = armorBody
		...
		PartDefinition cube_r9 = armorBody.addOrReplaceChild("cube_r9",
		...
		PartDefinition cube_r10 = armorBody.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 12).addBox(-1.0704F, -0.3506F, -0.4375F, 1.0F, 1.5F, 0.875F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.1228F, -1.75F, -0.0715F, 0.05F, 0.6091F));

		PartDefinition cube_r11 = armorBody.addOrReplaceChild("cube_r11",

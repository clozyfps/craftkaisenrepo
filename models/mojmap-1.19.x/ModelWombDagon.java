...
public class ModelWombDagon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "wombdagon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(6.6005F, 4.1875F, -19.9764F, 16.0F, 14.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
				.addBox(7.6005F, -8.8125F, -18.9764F, 14.0F, 13.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 30)
				.addBox(5.6005F, -9.8125F, -20.9764F, 18.0F, 1.0F, 18.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-14.6005F, 5.8125F, 11.9764F));

		PartDefinition torso_r1 = body.addOrReplaceChild("torso_r1",
				CubeListBuilder.create().texOffs(64, 23).addBox(-9.0F, -3.0F, -0.5F, 18.0F, 6.0F, 0.0F,
		...
		PartDefinition torso_r2 = body.addOrReplaceChild("torso_r2",
				CubeListBuilder.create().texOffs(58, 74)
						.addBox(-10.0F, 9.5F, 0.5F, 18.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(64, 0)
						.addBox(-10.0F, -12.5F, -0.5F, 18.0F, 22.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r3 = body.addOrReplaceChild("torso_r3",
				CubeListBuilder.create().texOffs(0, 58)
						.addBox(0.5F, 9.5F, -9.0F, 0.0F, 3.0F, 18.0F, new CubeDeformation(0.0F)).texOffs(56, 31)
						.addBox(-0.5F, -12.5F, -9.0F, 1.0F, 22.0F, 18.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r4 = body.addOrReplaceChild("torso_r4",
				CubeListBuilder.create().texOffs(58, 53)
						.addBox(-0.5F, 9.5F, -9.0F, 0.0F, 3.0F, 18.0F, new CubeDeformation(0.0F)).texOffs(38, 71)
						.addBox(-0.5F, -12.5F, -9.0F, 1.0F, 22.0F, 18.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r5 = body.addOrReplaceChild("torso_r5",
				CubeListBuilder.create().texOffs(0, 36).addBox(-2.0F, -1.5F, -1.0F, 4.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r6 = body.addOrReplaceChild("torso_r6",
				CubeListBuilder.create().texOffs(28, 76).addBox(-2.0F, -2.0F, -4.5F, 4.0F, 4.0F, 8.0F,
		...
		PartDefinition torso_r7 = body.addOrReplaceChild("torso_r7",
				CubeListBuilder.create().texOffs(58, 77).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r8 = body.addOrReplaceChild("torso_r8",
				CubeListBuilder.create().texOffs(76, 29).addBox(-2.0F, -2.0F, -4.5F, 4.0F, 4.0F, 8.0F,
						new CubeDeformation(-0.01F)),
		...
		PartDefinition torso_r9 = body.addOrReplaceChild("torso_r9",
				CubeListBuilder.create().texOffs(0, 79).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r10 = body.addOrReplaceChild("torso_r10",
				CubeListBuilder.create().texOffs(12, 7).addBox(-3.5F, 2.1543F, -1.1278F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r11 = body.addOrReplaceChild("torso_r11",
				CubeListBuilder.create().texOffs(12, 10).addBox(-1.5F, 3.6909F, -0.4505F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r12 = body.addOrReplaceChild("torso_r12",
				CubeListBuilder.create().texOffs(48, 0).addBox(0.0F, -0.152F, -1.3658F, 2.0F, 5.0F, 2.0F,
		...
		PartDefinition torso_r13 = body.addOrReplaceChild("torso_r13",
				CubeListBuilder.create().texOffs(0, 13)
						.addBox(2.5F, 3.679F, -0.0402F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 7)
						.addBox(2.0F, -0.321F, -0.5402F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.001F)).texOffs(6, 53)
						.addBox(0.0F, -3.7933F, -1.3586F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r14 = body.addOrReplaceChild("torso_r14",
				CubeListBuilder.create().texOffs(54, 11)
						.addBox(-4.0F, -0.447F, -0.5738F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.001F)).texOffs(0, 0)
						.addBox(-3.0F, -8.6605F, -1.684F, 6.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r15 = body.addOrReplaceChild("torso_r15",
				CubeListBuilder.create().texOffs(0, 49).addBox(-2.0F, -0.1689F, -1.5554F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(-0.001F)),
		...
		PartDefinition torso_r16 = body.addOrReplaceChild("torso_r16",
				CubeListBuilder.create().texOffs(4, 13).addBox(0.5F, 4.4547F, 1.14F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r17 = body.addOrReplaceChild("torso_r17",
				CubeListBuilder.create().texOffs(42, 49)
						.addBox(2.0F, -3.9975F, -0.5054F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 53)
						.addBox(-4.0F, -3.9975F, -0.5054F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(14.6005F, 2.1307F, -21.2857F, -0.1745F, 0.0F, 0.0F));

		PartDefinition torso_r18 = body.addOrReplaceChild("torso_r18",
				CubeListBuilder.create().texOffs(54, 30).addBox(-2.0F, -3.7606F, -1.5462F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r19 = body.addOrReplaceChild("torso_r19",
				CubeListBuilder.create().texOffs(0, 41).addBox(-2.0F, -1.5F, -1.0F, 4.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r20 = body.addOrReplaceChild("torso_r20",
				CubeListBuilder.create().texOffs(0, 7).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r21 = body.addOrReplaceChild("torso_r21",
				CubeListBuilder.create().texOffs(0, 30).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),

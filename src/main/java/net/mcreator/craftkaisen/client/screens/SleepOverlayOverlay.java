...
import net.mcreator.craftkaisen.procedures.SleepOverlayDisplayOverlayIngameProcedure;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.platform.GlStateManager;

@Mod.EventBusSubscriber({Dist.CLIENT})
public class SleepOverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (SleepOverlayDisplayOverlayIngameProcedure.execute(entity)) {
			...
			Minecraft.getInstance().gui.blit(event.getPoseStack(), w / 2 + -813, h / 2 + -477, 0, 0, 1920, 1080, 1920, 1080);

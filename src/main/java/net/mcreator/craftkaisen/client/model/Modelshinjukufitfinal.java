...
public class Modelshinjukufitfinal<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_kaisen", "modelshinjukufitfinal"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bipedHead = Body.addOrReplaceChild("bipedHead", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition armorLeftArm = RightArm.addOrReplaceChild("armorLeftArm", CubeListBuilder.create().texOffs(53, 14).addBox(-4.25F, -2.25F, -2.5F, 3.25F, 5.5F, 4.8125F, new CubeDeformation(0.0F)).texOffs(11, 59)
		...
		PartDefinition armorRightArm = LeftArm.addOrReplaceChild("armorRightArm", CubeListBuilder.create().texOffs(54, 102).addBox(1.0F, 4.25F, -2.5F, 3.25F, 1.0F, 4.8125F, new CubeDeformation(0.0F)).texOffs(15, 77)
		...
		PartDefinition armorLeftLeg = LeftLeg.addOrReplaceChild("armorLeftLeg",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition armorLeftBoot = LeftLeg.addOrReplaceChild("armorLeftBoot", CubeListBuilder.create().texOffs(54, 25).addBox(1.1875F, 11.0F, -1.9375F, 4.875F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition armorRightLeg = RightLeg.addOrReplaceChild("armorRightLeg",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition armorRightBoot = RightLeg.addOrReplaceChild("armorRightBoot", CubeListBuilder.create().texOffs(35, 76).addBox(-6.0625F, 11.0F, -2.0625F, 4.875F, 1.0F, 4.125F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

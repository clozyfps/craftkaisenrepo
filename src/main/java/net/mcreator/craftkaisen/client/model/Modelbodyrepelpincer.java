...
public class Modelbodyrepelpincer<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_kaisen", "modelbodyrepelpincer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Bodyrepel = partdefinition.addOrReplaceChild("Bodyrepel",
				CubeListBuilder.create().texOffs(130, 151).addBox(-9.0F, -18.0F, -19.0F, 18.0F, 18.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(116, 62).addBox(-10.0F, -22.0F, -22.0F, 20.0F, 4.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(61, 0)
						.addBox(-10.0F, -26.0F, -23.0F, 20.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(122, 28).addBox(-10.0F, 0.0F, -18.0F, 20.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(176, 37)
						.addBox(-10.0F, 2.0F, -20.0F, 20.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(190, 98).addBox(-9.0F, 4.0F, -20.0F, 18.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(58, 101)
						...
						.addBox(-9.0F, -18.0F, 79.0F, 18.0F, 18.0F, 25.0F, new CubeDeformation(0.0F)).texOffs(70, 172).addBox(-8.0F, -17.0F, 101.0F, 16.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(24, 172)
		...
		PartDefinition cube_r1 = Bodyrepel.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 83).addBox(-10.0F, -18.0F, -26.0F, 2.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(166, 102).addBox(-8.0F, -24.0F, -29.0F, 4.0F, 18.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(18, 205)
						.addBox(-4.0F, -36.0F, -31.0F, 4.0F, 30.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(4.0F, -24.0F, -29.0F, 4.0F, 18.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 205)
						.addBox(0.0F, -36.0F, -31.0F, 4.0F, 30.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 43).addBox(8.0F, -18.0F, -26.0F, 2.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1345F, 0.0F, -3.1416F));
		PartDefinition cube_r2 = Bodyrepel.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(72, 208).addBox(4.0F, -33.0F, -14.0F, 4.0F, 18.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(36, 208).addBox(0.0F, -45.0F, -16.0F, 4.0F, 30.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(112, 102)
						.addBox(8.0F, -27.0F, -11.0F, 2.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 123).addBox(-10.0F, -27.0F, -11.0F, 2.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(200, 0)
						.addBox(-8.0F, -33.0F, -14.0F, 4.0F, 18.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(54, 208).addBox(-4.0F, -45.0F, -16.0F, 4.0F, 30.0F, 5.0F, new CubeDeformation(0.0F)),

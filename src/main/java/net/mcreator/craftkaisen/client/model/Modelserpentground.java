...
public class Modelserpentground<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_kaisen", "modelserpentground"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition serpent = partdefinition.addOrReplaceChild("serpent", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 19.0F, 0.0F, 1.5272F, 0.0F, 3.1416F));

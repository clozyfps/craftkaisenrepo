...
public class Modelitadoriuniform<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_kaisen", "modelitadoriuniform"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 18).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(0, 0).addBox(-4.0F, 0.0F, -2.5F, 8.0F, 13.0F, 5.0F, new CubeDeformation(0.25F)).texOffs(47, 3)
						.addBox(-1.0F, -1.25F, -4.5F, 0.5F, 0.55F, 0.0F, new CubeDeformation(0.25F)).texOffs(47, 3).addBox(1.5F, 1.5F, -2.75F, 0.5F, 0.55F, 0.0F, new CubeDeformation(0.25F)),

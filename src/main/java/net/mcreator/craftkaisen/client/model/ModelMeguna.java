...
public class ModelMeguna<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_kaisen", "model_meguna"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r70 = bone.addOrReplaceChild("head_r70", CubeListBuilder.create().texOffs(36, 69).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.3933F, -5.9501F, 0.7693F, -0.8599F, 0.5158F, 0.3888F));
		PartDefinition head_r71 = bone.addOrReplaceChild("head_r71", CubeListBuilder.create().texOffs(6, 71).mirror().addBox(-1.25F, -1.5F, -2.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.9463F, -4.65F, 2.85F, -1.0104F, 0.3458F, 0.2381F));
		PartDefinition head_r72 = bone.addOrReplaceChild("head_r72", CubeListBuilder.create().texOffs(6, 71).addBox(0.25F, -1.5F, -2.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.65F, -4.65F, 2.85F, -1.0104F, -0.3458F, -0.2381F));
		PartDefinition head_r73 = bone.addOrReplaceChild("head_r73", CubeListBuilder.create().texOffs(36, 69).mirror().addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.203F, -5.9501F, 0.7693F, -0.8599F, -0.5158F, -0.3888F));
		PartDefinition head_r74 = bone.addOrReplaceChild("head_r74", CubeListBuilder.create().texOffs(6, 71).addBox(0.25F, -1.5F, -2.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.65F, -5.65F, -0.15F, -1.0104F, -0.3458F, -0.2381F));
		PartDefinition head_r75 = bone.addOrReplaceChild("head_r75", CubeListBuilder.create().texOffs(6, 71).mirror().addBox(-1.25F, -1.5F, -2.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition head_r76 = bone.addOrReplaceChild("head_r76",
				CubeListBuilder.create().texOffs(6, 71).mirror().addBox(-1.25F, -1.5F, -2.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(72, 43).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition head_r77 = bone.addOrReplaceChild("head_r77",
				CubeListBuilder.create().texOffs(6, 71).addBox(0.25F, -1.5F, -2.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(6, 71).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.35F, -3.55F, -4.15F, -1.0104F, -0.3458F, -0.2381F));
		PartDefinition head_r78 = bone.addOrReplaceChild("head_r78", CubeListBuilder.create().texOffs(74, 70).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.05F, -3.55F, 0.25F, -1.1071F, -0.5033F, -0.3207F));
		PartDefinition head_r79 = bone.addOrReplaceChild("head_r79", CubeListBuilder.create().texOffs(10, 73).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.9463F, -2.3F, 1.0F, -1.0104F, 0.3458F, 0.2381F));
		PartDefinition head_r80 = bone.addOrReplaceChild("head_r80", CubeListBuilder.create().texOffs(62, 64).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.6963F, -0.8F, 0.25F, -1.0104F, 0.3458F, 0.2381F));
		PartDefinition head_r81 = bone.addOrReplaceChild("head_r81", CubeListBuilder.create().texOffs(36, 69).mirror().addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.203F, -6.9501F, -2.2307F, -0.8599F, -0.5158F, -0.3888F));
		PartDefinition head_r82 = bone.addOrReplaceChild("head_r82", CubeListBuilder.create().texOffs(36, 69).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.3933F, -6.9501F, -2.2307F, -0.8599F, 0.5158F, 0.3888F));
		PartDefinition head_r83 = bone.addOrReplaceChild("head_r83", CubeListBuilder.create().texOffs(36, 69).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.8463F, -3.25F, -2.0F, -1.3158F, 0.3458F, 0.2381F));
		PartDefinition head_r84 = bone.addOrReplaceChild("head_r84", CubeListBuilder.create().texOffs(0, 59).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.8463F, -2.25F, -0.75F, -1.3158F, 0.3458F, 0.2381F));
		PartDefinition head_r85 = bone.addOrReplaceChild("head_r85", CubeListBuilder.create().texOffs(74, 22).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.5463F, -2.05F, -4.0F, -1.1071F, 0.5033F, 0.3207F));
		PartDefinition head_r86 = bone.addOrReplaceChild("head_r86", CubeListBuilder.create().texOffs(76, 28).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.5463F, -3.55F, 0.25F, -1.1071F, 0.5033F, 0.3207F));
		PartDefinition head_r87 = bone.addOrReplaceChild("head_r87", CubeListBuilder.create().texOffs(50, 74).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.5463F, -1.55F, -2.75F, -1.1071F, 0.5033F, 0.3207F));
		PartDefinition head_r88 = bone.addOrReplaceChild("head_r88", CubeListBuilder.create().texOffs(40, 62).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.5963F, 0.0F, 0.0F, -1.3158F, 0.3458F, 0.2381F));
		PartDefinition head_r89 = bone.addOrReplaceChild("head_r89", CubeListBuilder.create().texOffs(48, 8).addBox(-1.8741F, -3.4789F, -1.3952F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0482F, 1.6662F, 1.4891F, -0.9231F, -0.3458F, -0.2381F));
		PartDefinition head_r90 = bone.addOrReplaceChild("head_r90", CubeListBuilder.create().texOffs(47, 0).addBox(0.8741F, -3.4789F, -1.3952F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5482F, 1.6662F, 1.4891F, -0.9231F, 0.3458F, 0.2381F));
		PartDefinition head_r91 = bone.addOrReplaceChild("head_r91", CubeListBuilder.create().texOffs(30, 65).addBox(-1.2018F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5F, 0.95F, 2.0F, -0.9672F, 0.0099F, 0.0F));
		PartDefinition head_r92 = bone.addOrReplaceChild("head_r92", CubeListBuilder.create().texOffs(0, 16).addBox(-2.8741F, -3.4789F, -2.3952F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7982F, 0.1662F, 1.9891F, -0.9231F, -0.3458F, -0.2381F));
		PartDefinition head_r93 = bone.addOrReplaceChild("head_r93", CubeListBuilder.create().texOffs(57, 85).addBox(-1.674F, -2.3114F, -1.9746F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7982F, -0.0838F, 1.9891F, -1.2339F, -0.0349F, -0.29F));
		PartDefinition head_r94 = bone.addOrReplaceChild("head_r94", CubeListBuilder.create().texOffs(6, 87).addBox(-0.326F, -2.3114F, -1.9746F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7982F, -0.0838F, 1.9891F, -1.2339F, 0.0349F, 0.29F));
		PartDefinition head_r95 = bone.addOrReplaceChild("head_r95", CubeListBuilder.create().texOffs(0, 84).addBox(0.8741F, -3.4789F, -2.3952F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7982F, 0.1662F, 1.9891F, -0.9231F, 0.3458F, 0.2381F));
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(40, 17).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(62, 36)
				.addBox(-2.0F, 10.0F, -4.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(82, 57).addBox(-2.0F, -0.25F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 12.0F, 0.0F));
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild(
				"right_leg", CubeListBuilder.create().texOffs(40, 17).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(62, 36).mirror()
						.addBox(-2.0F, 10.0F, -4.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(82, 57).mirror().addBox(-2.0F, -0.25F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),

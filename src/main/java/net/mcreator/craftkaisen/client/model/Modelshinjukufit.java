...
public class Modelshinjukufit<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craft_kaisen", "modelshinjukufit"), "main");
	...
	public Modelshinjukufit(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = armorHead.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(77, 1).addBox(-4.25F, -0.5F, -4.125F, 8.5F, 1.0F, 8.25F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.5059F, -0.1467F, 0.0436F, 0.0F, 0.0F));
		PartDefinition cube_r3 = armorHead.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -1.0F, -4.5F, 9.0F, 2.5F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = armorBody.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 21).addBox(-5.0F, -3.5F, -2.0F, 10.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.5F, 1.25F, 0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r5 = armorBody.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(10, 66).addBox(2.4023F, -2.0932F, -2.2188F, 3.0F, 5.5625F, 2.4375F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 9.1603F, -0.0313F, -0.258F, -0.045F, -0.1687F));
		PartDefinition cube_r6 = armorBody.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 64).addBox(-5.4023F, -2.0932F, -2.2188F, 3.0F, 5.5625F, 2.4375F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 9.1603F, -0.0313F, -0.258F, 0.045F, 0.1687F));
		PartDefinition cube_r7 = armorBody.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(55, 52).addBox(-2.0F, -3.8125F, -2.25F, 3.0F, 5.5625F, 4.4375F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.634F, 9.5891F, 0.0F, 0.0F, 0.0F, -0.1745F));
		PartDefinition cube_r8 = armorBody.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(42, 58).addBox(-1.0F, -3.8125F, -2.25F, 3.0F, 5.5625F, 4.4375F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.634F, 9.5891F, 0.0F, 0.0F, 0.0F, 0.1745F));
		PartDefinition cube_r9 = armorBody.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(5, 6).addBox(0.0704F, -0.3506F, -0.4375F, 1.0F, 1.5F, 0.875F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.1228F, -1.75F, -0.0715F, -0.05F, -0.6091F));
		PartDefinition cube_r10 = armorBody.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 12).addBox(-1.0704F, -0.3506F, -0.4375F, 1.0F, 1.5F, 0.875F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.1228F, -1.75F, -0.0715F, 0.05F, 0.6091F));
		PartDefinition cube_r11 = armorBody.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(64, 12).addBox(-2.25F, -2.75F, -0.25F, 4.5F, 5.5F, 0.0F, new CubeDeformation(0.0F)),

...
public class NueRenderer extends GeoEntityRenderer<NueEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, NueEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,

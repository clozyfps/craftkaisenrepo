...
import net.mcreator.craftkaisen.procedures.DisplayDomainNum7Procedure;
import net.mcreator.craftkaisen.procedures.DisplayDomainNum6Procedure;
import net.mcreator.craftkaisen.procedures.DisplayDomainNum5Procedure;
import net.mcreator.craftkaisen.procedures.DisplayDomainNum4Procedure;
import net.mcreator.craftkaisen.procedures.DisplayDomainNum3Procedure;
import net.mcreator.craftkaisen.procedures.DisplayDomainNum2Procedure;
import net.mcreator.craftkaisen.procedures.DisplayDomainNum1Procedure;
...
public class DomainClashScreen extends AbstractContainerScreen<DomainClashMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + -65, this.topPos + -66, 0, 0, 178, 178, 178, 178);
	...
	public void init() {
		super.init();
		imagebutton_press = new ImageButton(this.leftPos + -26, this.topPos + -22, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press.png"), 40, 48, e -> {
			if (DisplayDomainNum1Procedure.execute(entity)) {
		...
		imagebutton_press1 = new ImageButton(this.leftPos + 34, this.topPos + -15, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press1.png"), 40, 48, e -> {
			if (DisplayDomainNum2Procedure.execute(entity)) {
		...
		imagebutton_press2 = new ImageButton(this.leftPos + -46, this.topPos + 9, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press2.png"), 40, 48, e -> {
			if (DisplayDomainNum3Procedure.execute(entity)) {
		...
		imagebutton_press3 = new ImageButton(this.leftPos + 1, this.topPos + 37, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press3.png"), 40, 48, e -> {
			if (DisplayDomainNum5Procedure.execute(entity)) {
		...
		imagebutton_press4 = new ImageButton(this.leftPos + -47, this.topPos + 70, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press4.png"), 40, 48, e -> {
			if (DisplayDomainNum6Procedure.execute(entity)) {
		...
		imagebutton_press5 = new ImageButton(this.leftPos + 60, this.topPos + 19, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press5.png"), 40, 48, e -> {
			if (DisplayDomainNum7Procedure.execute(entity)) {
		...
		imagebutton_press6 = new ImageButton(this.leftPos + 42, this.topPos + 65, 40, 24, 0, 0, 24, new ResourceLocation("craft_kaisen:textures/screens/atlas/imagebutton_press6.png"), 40, 48, e -> {
			if (DisplayDomainNum4Procedure.execute(entity)) {

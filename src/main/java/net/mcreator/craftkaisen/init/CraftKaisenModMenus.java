...
public class CraftKaisenModMenus {
	...
	public static final RegistryObject<MenuType<DomainClashingGUIMenu>> DOMAIN_CLASHING_GUI = REGISTRY.register("domain_clashing_gui", () -> IForgeMenuType.create(DomainClashingGUIMenu::new));
}

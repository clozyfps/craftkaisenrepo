...
public class CraftKaisenModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(Modelovertimemodel.LAYER_LOCATION, Modelovertimemodel::createBodyLayer);
		...
		event.registerLayerDefinition(Modelcursedbudentity.LAYER_LOCATION, Modelcursedbudentity::createBodyLayer);

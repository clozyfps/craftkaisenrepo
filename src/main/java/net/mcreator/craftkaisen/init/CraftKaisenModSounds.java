...
public class CraftKaisenModSounds {
	...
	public static final RegistryObject<SoundEvent> UNLIMITEDVOID = REGISTRY.register("unlimitedvoid", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("craft_kaisen", "unlimitedvoid")));
	public static final RegistryObject<SoundEvent> UNLIMITEDSPLASH = REGISTRY.register("unlimitedsplash", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("craft_kaisen", "unlimitedsplash")));

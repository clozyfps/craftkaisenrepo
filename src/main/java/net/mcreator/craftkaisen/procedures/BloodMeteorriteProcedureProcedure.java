...
public class BloodMeteorriteProcedureProcedure {
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			if (!projectileLevel.isClientSide()) {
				...
				}.getArrow(projectileLevel, entity, (float) ((entity.getCapability(CraftKaisenModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftKaisenModVariables.PlayerVariables())).currentOutput / 7), 0);

	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
			...
			return;
		{
			...
			for (Entity entityiterator : _entfound) {
				if ((entity.getCapability(CraftKaisenModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftKaisenModVariables.PlayerVariables())).OverTimeNBT == entityiterator.getPersistentData().getDouble("overtimenbt")) {

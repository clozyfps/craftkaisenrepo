...
public class WoodenBoxEntity extends TamableAnimal {
	...
	public WoodenBoxEntity(EntityType<WoodenBoxEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		WoodenBoxEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WoodenBoxEntity retval = CraftKaisenModEntities.WOODEN_BOX.get().create(serverWorld);

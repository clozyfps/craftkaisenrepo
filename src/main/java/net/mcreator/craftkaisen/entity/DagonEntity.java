...
public class DagonEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(CraftKaisenModEntities.DAGON.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}

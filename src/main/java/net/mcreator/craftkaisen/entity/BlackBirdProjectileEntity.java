...
import net.mcreator.craftkaisen.procedures.BlackBirdProjectileWhileProjectileFlyingTickProcedure;
import net.mcreator.craftkaisen.procedures.BlackBirdProjectileProjectileHitsLivingEntityProcedure;

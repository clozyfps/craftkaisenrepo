...
public class BassBoosterEntity extends TamableAnimal {
	...
	public BassBoosterEntity(EntityType<BassBoosterEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BassBoosterEntity retval = CraftKaisenModEntities.BASS_BOOSTER.get().create(serverWorld);

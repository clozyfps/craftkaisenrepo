...
import net.mcreator.craftkaisen.procedures.GuitarBlastWhileProjectileFlyingTickProcedure;
import net.mcreator.craftkaisen.procedures.GuitarBlastProjectileHitsBlockProcedure;

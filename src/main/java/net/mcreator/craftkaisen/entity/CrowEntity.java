...
import net.mcreator.craftkaisen.procedures.CrowOnInitialEntitySpawnProcedure;
...
public class CrowEntity extends TamableAnimal {
	public CrowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftKaisenModEntities.CROW.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new Goal() {
			...
			public boolean canContinueToUse() {
				return CrowEntity.this.getMoveControl().hasWanted() && CrowEntity.this.getTarget() != null && CrowEntity.this.getTarget().isAlive();
			}
			...
			public void start() {
				...
				CrowEntity.this.moveControl.setWantedPosition(vec3d.x, vec3d.y, vec3d.z, 3);
			}
		...
		this.goalSelector.addGoal(5, new RandomStrollGoal(this, 2.6, 20) {
			@Override
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		CrowOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CrowEntity retval = CraftKaisenModEntities.CROW.get().create(serverWorld);
